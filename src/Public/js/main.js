...
fetch('/api/session/current')
    ...
    .then(data => {
        ...
        const buttonToPay = document.getElementById("purchase")
            if(cartIcon){
                cartIcon.addEventListener('click',()=>{
                    window.location.replace(`/carts/${data.user.cart}`)
                })
